...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      {/* Container tùy chỉnh với TailwindCSS */}

      <SignUp
        path="/sign-up" // Đường dẫn của trang đăng ký
        routing="path" // Hoặc có thể dùng "virtual" nếu bạn không muốn thay đổi URL
        signInUrl="/sign-in" // Liên kết chuyển sang trang đăng nhập
        appearance={{
          elements: {
            // Tùy chỉnh các phần tử sử dụng lớp TailwindCSS
            rootBox: "p-4",
            card: "shadow-lg p-6 rounded-lg",
            formButtonPrimary:
              "bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded",
            formTitle: "text-2xl font-semibold mb-4 text-center",
          },
        }}
      />
    </div>
